...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file:///Users/dee_vyn/monolithic-ralph/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/dee_vyn/monolithic-ralph/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/dee_vyn/monolithic-ralph/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/dee_vyn/monolithic-ralph/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/dee_vyn/monolithic-ralph/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/dee_vyn/monolithic-ralph/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/dee_vyn/monolithic-ralph/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///Users/dee_vyn/monolithic-ralph/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/dee_vyn/monolithic-ralph/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/dee_vyn/monolithic-ralph/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/dee_vyn/monolithic-ralph/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/dee_vyn/monolithic-ralph/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/dee_vyn/monolithic-ralph/node_modules/radix3/dist/index.mjs';
import consola, { consola as consola$1 } from 'file:///Users/dee_vyn/monolithic-ralph/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/dee_vyn/monolithic-ralph/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/dee_vyn/monolithic-ralph/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/dee_vyn/monolithic-ralph/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/dee_vyn/monolithic-ralph/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/dee_vyn/monolithic-ralph/node_modules/errx/dist/index.js';
import { isVNode, isRef, toValue } from 'file:///Users/dee_vyn/monolithic-ralph/node_modules/vue/index.mjs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///Users/dee_vyn/monolithic-ralph/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/dee_vyn/monolithic-ralph/node_modules/unhead/dist/server.mjs';
import { renderToString } from 'file:///Users/dee_vyn/monolithic-ralph/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///Users/dee_vyn/monolithic-ralph/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/dee_vyn/monolithic-ralph/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/dee_vyn/monolithic-ralph","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/dee_vyn/monolithic-ralph/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/dee_vyn/monolithic-ralph/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/dee_vyn/monolithic-ralph/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/dee_vyn/monolithic-ralph/.data/kv"}));
...
const _qBnFp1MhI4nSBRS91ErXoXNj0hGhwdo62D8lW08LFjs = (nitroApp) => {
...
const _KXkssT = eventHandler((event) => {
...
const getServerEntry = () => import('file:///Users/dee_vyn/monolithic-ralph/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
// @ts-expect-error file will be produced after app build
const getClientManifest = () => import('file:///Users/dee_vyn/monolithic-ralph/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
// -- SSR Renderer --
...
const handlers = [
  ...
  { route: '/**', handler: _lazy_7CVTns, lazy: true, middleware: false, method: undefined }
];

...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "antialiased bg-white dark:bg-[#020420] dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-[#020420] tracking-wide" }, _attrs))} data-v-d6beb1d7><div class="max-w-520px text-center" data-v-d6beb1d7><h1 class="font-semibold leading-none mb-4 sm:text-[110px] tabular-nums text-[80px]" data-v-d6beb1d7>${ssrInterpolate($props.status)}</h1><h2 class="font-semibold mb-2 sm:text-3xl text-2xl" data-v-d6beb1d7>${ssrInterpolate($props.statusText)}</h2><p class="mb-4 px-2 text-[#64748B] text-md" data-v-d6beb1d7>${ssrInterpolate($props.description)}</p></div></div>`);
}
...
const error500 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-d6beb1d7"], ["__file", "/Users/dee_vyn/monolithic-ralph/node_modules/nuxt/dist/app/components/error-500.vue"]]);
export {
  error500 as default
};
//# sourceMappingURL=error-500-3c_dwhkO.js.map

...
import { parseQuery, hasProtocol, joinURL, withTrailingSlash, withoutTrailingSlash } from "/Users/dee_vyn/monolithic-ralph/node_modules/ufo/dist/index.mjs";
...
import { u as useHead } from "./composables-Cks_C5kv.js";
...
import "@vue/shared";
import "/Users/dee_vyn/monolithic-ralph/node_modules/@unhead/vue/dist/index.mjs";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "antialiased bg-white dark:bg-[#020420] dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-[#020420] tracking-wide" }, _attrs))} data-v-fdc70557><div class="max-w-520px text-center" data-v-fdc70557><h1 class="font-semibold leading-none mb-4 sm:text-[110px] tabular-nums text-[80px]" data-v-fdc70557>${ssrInterpolate($props.status)}</h1><h2 class="font-semibold mb-2 sm:text-3xl text-2xl" data-v-fdc70557>${ssrInterpolate($props.statusText)}</h2><p class="mb-4 px-2 text-[#64748B] text-md" data-v-fdc70557>${ssrInterpolate($props.description)}</p><div class="flex items-center justify-center w-full" data-v-fdc70557>`);
...
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-fdc70557"], ["__file", "/Users/dee_vyn/monolithic-ralph/node_modules/nuxt/dist/app/components/error-404.vue"]]);
export {
  error404 as default
};
//# sourceMappingURL=error-404-CxBC0I9W.js.map
